Place logo image files in these folders so the site can render them via next/image.
...
- If a logo is dark-on-transparent, export a light/white variant for the dark UI.
